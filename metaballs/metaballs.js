...
function createCircle(container){
    ...
    switch(Math.floor(Math.random() * 4)) {
        // off up
        case 0:
            translation = { transform: `translate(${Math.random() * 200}%, -150%)` }
            break;
        // off down
        case 2:
            translation = { transform: `translate(${Math.random() * 200}%, 250%)` }
            break;
        // off left
        case 3:
            translation = { transform: `translate(-150%, ${Math.random() * 200}%)` }
            break;
        // off right
        default:
            translation = { transform: `translate(250%, ${Math.random() * 200}%)` }
            break;
    } 
